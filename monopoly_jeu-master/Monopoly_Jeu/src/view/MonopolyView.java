...
public class MonopolyView extends ViewModel {
	...
	/**
	 * Constructeur Une instance de Stage est généré au démarrage. Ceci afin de
	 * choisir un nombre de joueur avant le début de la partie.
	 * 
	...
	public void initRoot() {
		...
		tourSuivant.setOnAction(new JeuTourSuivantController(this));
	...
	/**
	 * Méthode permettant de lancer une partie. Instanciation d'une partie avec le
	 * nombre de joueurs rentré C'est ci que les comptes des joueurs et les éléments
	 * graphique vont être initialisés la liste de leurs Salaries et les pions.
	 * 
	 * @param nbJoueurs int
	 */
	...
	/**
	 * Cette méthode est appelé à chaque fois qu'un rafraichissement des labels est
	...
	/**
	 * Affiche la fenêtre FenetreCarteChance}. Les paramètres String Intitule et
	 * String description passés seront utilisés dans la fenêtre pour indiquer
	 * qu'elle carte on a tiré.
	 * 
	 ...
	 * @param cells Case
	 */
	public void setCompetence(CaseSalarieController cells) {
	...
	/**
	 * Déplace le pion du joueur actif en fonction de la position sur le plateau de
	...
	/**
	 * Réinitialise les éléments graphiques de la fenêtre tels que les labels, les
	 * pions et les logs.
	 */
