...
public class CaseClientController extends CaseModel implements DefaultControllerInterface {
	 ...
	 * Gère le changement du Salaire en fonction du nombre de Client possédé par un
	 * joueur
	 * 
	 * @see Joueur
	 * @see Case
