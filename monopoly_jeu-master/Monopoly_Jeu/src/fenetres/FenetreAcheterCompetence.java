...
/**
 * Fenêtre à afficher lorqu'on atterit sur une {@link CaseCompetence} sans propriétaire.<br><br>
 * ** <b>Action réalisable : </b> Acheter le Competence
 * @see FenetreDeJeu
 */
public class FenetreAcheterCompetence {
	
	private FenetreDeJeu fp;
	private Stage stage;
	private HBox root;
	...
	/**
	 * Unique constructeur de la classe {@link FenetreAcheterCompetence}, prenant en paramètre la {@link FenetreDeJeu} fp.
	 * @param fp FenetreDeJeu
	 * @see FenetreDeJeu
	 */
	public FenetreAcheterCompetence(FenetreDeJeu fp) {
	...
	/**
	 * Initialise la HBox root de la FenetreAcheterCompetence avec une image, un label posant une question et des boutons Oui/Non.
	 */
	private void initRoot() {
		...
		case "Gare Montparnasse": i_Competence = new Image("images/gare.jpg"); break;
		case "Gare de Lyon": i_Competence = new Image("images/gare.jpg"); break;
		case "Gare du Nord": i_Competence = new Image("images/gare.jpg"); break;
		case "Gare Saint-Lazare": i_Competence = new Image("images/gare.jpg"); break;
		case "Compagnie des eaux": i_Competence = new Image("images/eau.jpg"); break;
		case "Compagnie d'électricité": i_Competence = new Image("images/elec.jpg"); break;
		default: {
	...
	private class EvtOui implements EventHandler<ActionEvent> {
		...
		public void handle(ActionEvent event) {
			fp.getPartie().getPM().getCaseActive().setRep(true);
			stage.close();
			event.consume();
		}
	}
	...
	/**
	 * Evènement : 
	 * Si l'utilisateur ferme la fenêtre la réponse reste à FALSE.
	 */
	...
	/**
	 * Evènement 
	 * Si l'utilisateur ferme la fenêtre la partie reprend.
	 */
