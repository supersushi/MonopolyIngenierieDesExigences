...
//	CaseSalarie caseSal3 = (CaseSalarie) plateau.getCase(9);
	...
	@Test
	/**
	 * Permet de tester la méthode actionCase
	 * dans le cas où le joueur1 embauche le salarie
	 * donc le joueur1 devient le patron de la case, son argent baisse et le salarié est ajouté dans sa liste de salariés
	 */
	void actionCaseEmbaucheTest() {
		caseSal.setRep(true);
		caseSal.setId(25);
		caseSal.actionCase(joueur1, null, null);
	...
	/**
	 * Permet de tester la méthode actionCase
	 * dans le cas où ce n'est pas le patron de la case qui tombe dessus
	 * donc l'argent du joueur2 baisse et celui du joueur1 augmente
	 */
	void actionCasePayerTest() {
		caseSal.setPatron(joueur1);
		caseSal.actionCase(joueur2, null, null);
	...
	@Test 
	/**
	 * Permet de tester la méthode embaucherSalarie
	 * dans le cas où le joueur2 n'a pas assez d'argent
	...
	@Test
	/**
	 * Permet de tester la méthode payerSalaire
	 * dans le cas où le patron (joueur1) est malade
	 * donc joueur2 ne verse pas de salaire
	 */
	...
	@Test
	/**
	 * Permet de tester la méthode monterEnCompetence
	 * donc le nbCompetence augmente de 1
	 */
	...
	@Test
	/**
	 * Permet de tester la méthode getPeutMonterEnCompetence
	 * dans les différents cas de la méthode 
	 * (si le joueur1 possède toutes les cases de la même couleur, si le nombre de compétence a atteint son maximum)
	 */
