...
class CarteDeplacementTest {
	 ...
	 * dans le cas où la carte a un déplacement relatif et où le déplacement amène le joueur1 à passer par la case départ
	...
	/**
	 * Permet de tester la méthode actionCarte de la classe
	 * dans le cas où la carte est un arrêt maladie et où le joueur1 possède une carte de sortie d'arrêt maladie
	...
	/**
	 * Permet de tester la méthode actionCarte de la classe
	 * dans le cas où la carte est un arrêt maladie mais où le joueur1 ne possède pas de carte de sortie d'arrêt maladie
